...
INTEGRATION_TEST_HINTS_BY_DISCOVERY_MODE = {
    ...
    "knds_jobboard": "tests/integration/test_discover_public_service_sources.py",
    ...
    "phenom_html": "tests/integration/test_discover_phenom_html.py",
...
INTEGRATION_FILES_BY_DISCOVERY_MODE = {
    ...
    "knds_jobboard": "scripts/discover/sources/generic_html.py",
    ...
    "phenom_html": "scripts/discover/sources/phenom.py",
