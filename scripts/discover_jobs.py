...
def build_bundeswehr_odata_candidate(
    ...
    matched_terms = sorted(set(match_terms(searchable_text, terms) + list(forced_terms)))
    candidate = Candidate(
    ...
    for term in terms:
        try:
            ...
            limitations.append(
                ...
                f"({type(exc).__name__}: {truncate_text(str(exc), 160)})."
            )
            continue
...
from discover.sources.bundeswehr import BUNDESWEHR_COMPENSATION_HEADINGS as BUNDESWEHR_COMPENSATION_HEADINGS
from discover.sources.bundeswehr import BUNDESWEHR_COMPENSATION_MARKERS as BUNDESWEHR_COMPENSATION_MARKERS
from discover.sources.bundeswehr import BUNDESWEHR_DETAIL_STOP_HEADINGS as BUNDESWEHR_DETAIL_STOP_HEADINGS
from discover.sources.bundeswehr import BUNDESWEHR_JOB_TITLE_RE as BUNDESWEHR_JOB_TITLE_RE
from discover.sources.bundeswehr import BUNDESWEHR_JOBSUCHE_URL as BUNDESWEHR_JOBSUCHE_URL
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_DETAIL_SELECT as BUNDESWEHR_ODATA_DETAIL_SELECT
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_ENTITY_SET as BUNDESWEHR_ODATA_ENTITY_SET
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_LANGUAGE as BUNDESWEHR_ODATA_LANGUAGE
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_LIST_SELECT as BUNDESWEHR_ODATA_LIST_SELECT
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_OPPORTUNITY_CATEGORIES as BUNDESWEHR_ODATA_OPPORTUNITY_CATEGORIES
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_PAGE_SIZE as BUNDESWEHR_ODATA_PAGE_SIZE
from discover.sources.bundeswehr import BUNDESWEHR_ODATA_SERVICE_ROOT as BUNDESWEHR_ODATA_SERVICE_ROOT
from discover.sources.bundeswehr import BUNDESWEHR_QUALIFICATION_HEADINGS as BUNDESWEHR_QUALIFICATION_HEADINGS
from discover.sources.bundeswehr import BUNDESWEHR_TASK_HEADINGS as BUNDESWEHR_TASK_HEADINGS
from discover.sources.bundeswehr import apply_bundeswehr_detail_text as apply_bundeswehr_detail_text
from discover.sources.bundeswehr import apply_bundeswehr_odata_detail as apply_bundeswehr_odata_detail
from discover.sources.bundeswehr import build_bundeswehr_odata_candidate as build_bundeswehr_odata_candidate
from discover.sources.bundeswehr import build_bundeswehr_odata_candidate_notes as build_bundeswehr_odata_candidate_notes
from discover.sources.bundeswehr import build_bundeswehr_odata_candidate_url as build_bundeswehr_odata_candidate_url
from discover.sources.bundeswehr import build_bundeswehr_portal_candidate_url as build_bundeswehr_portal_candidate_url
from discover.sources.bundeswehr import bundeswehr_odata_category_filter_clause as bundeswehr_odata_category_filter_clause
from discover.sources.bundeswehr import bundeswehr_odata_detail_key as bundeswehr_odata_detail_key
from discover.sources.bundeswehr import bundeswehr_odata_filter_for_category as bundeswehr_odata_filter_for_category
from discover.sources.bundeswehr import bundeswehr_odata_filter_for_keyword as bundeswehr_odata_filter_for_keyword
from discover.sources.bundeswehr import bundeswehr_odata_searchable_text as bundeswehr_odata_searchable_text
from discover.sources.bundeswehr import candidate_searchable_text as candidate_searchable_text
from discover.sources.bundeswehr import clean_bundeswehr_odata_value as clean_bundeswehr_odata_value
from discover.sources.bundeswehr import discover_bundeswehr_jobsuche as discover_bundeswehr_jobsuche
from discover.sources.bundeswehr import discover_bundeswehr_odata as discover_bundeswehr_odata
from discover.sources.bundeswehr import discover_bundeswehr_profile_catalog_fallback as discover_bundeswehr_profile_catalog_fallback
from discover.sources.bundeswehr import extract_bundeswehr_detail_sections as extract_bundeswehr_detail_sections
from discover.sources.browser import BROWSER_STRATEGIES as BROWSER_STRATEGIES
from discover.sources.browser import GOOGLE_LOCATION_FILTERS as GOOGLE_LOCATION_FILTERS
from discover.sources.browser import GOOGLE_RESULTS_PAGE_SIZE as GOOGLE_RESULTS_PAGE_SIZE
from discover.sources.browser import accept_bosch_cookies as accept_bosch_cookies
from discover.sources.browser import accept_thales_cookies as accept_thales_cookies
from discover.sources.browser import advance_asml_results as advance_asml_results
from discover.sources.browser import advance_bosch_results as advance_bosch_results
from discover.sources.browser import advance_meta_results as advance_meta_results
from discover.sources.browser import apply_meta_detail_text as apply_meta_detail_text
from discover.sources.browser import bosch_search_url as bosch_search_url
from discover.sources.browser import dismiss_onetrust_banner as dismiss_onetrust_banner
from discover.sources.browser import discover_asml_browser as discover_asml_browser
from discover.sources.browser import discover_automattic_browser as discover_automattic_browser
from discover.sources.browser import discover_browser as discover_browser
from discover.sources.browser import discover_coinbase_browser as discover_coinbase_browser
from discover.sources.browser import discover_helsing_browser as discover_helsing_browser
from discover.sources.browser import discover_thales_browser as discover_thales_browser
from discover.sources.browser import discover_trailofbits_browser as discover_trailofbits_browser
from discover.sources.browser import enrich_meta_candidates as enrich_meta_candidates
from discover.sources.browser import extract_asml_jobs as extract_asml_jobs
from discover.sources.browser import extract_bosch_jobs as extract_bosch_jobs
from discover.sources.browser import extract_google_jobs as extract_google_jobs
from discover.sources.browser import extract_helsing_jobs as extract_helsing_jobs
from discover.sources.browser import extract_meta_detail_sections as extract_meta_detail_sections
from discover.sources.browser import extract_meta_jobs as extract_meta_jobs
from discover.sources.browser import google_degree_filters as google_degree_filters
from discover.sources.browser import google_filter_note as google_filter_note
from discover.sources.browser import google_location_filters as google_location_filters
from discover.sources.browser import google_public_job_url as google_public_job_url
from discover.sources.browser import google_search_url as google_search_url
from discover.sources.browser import load_sync_playwright as load_sync_playwright
from discover.sources.browser import meta_search_url as meta_search_url
from discover.sources.browser import normalize_google_degree_filter as normalize_google_degree_filter
from discover.sources.browser import playwright_browsers_missing_coverage as playwright_browsers_missing_coverage
from discover.sources.browser import playwright_import_missing_coverage as playwright_import_missing_coverage
...
from discover.sources.enbw import ENBW_RESULTS_PAGE_SIZE as ENBW_RESULTS_PAGE_SIZE
from discover.sources.enbw import build_enbw_apply_url as build_enbw_apply_url
from discover.sources.enbw import build_enbw_job_url as build_enbw_job_url
from discover.sources.enbw import build_enbw_search_url as build_enbw_search_url
from discover.sources.enbw import discover_enbw_phenom as discover_enbw_phenom
from discover.sources.generic_html import collect_job_links as collect_job_links
from discover.sources.generic_html import discover_cybernetica_teamdash as discover_cybernetica_teamdash
from discover.sources.generic_html import discover_filtered_html_links as discover_filtered_html_links
from discover.sources.generic_html import discover_html as discover_html
from discover.sources.generic_html import discover_secunet_jobboard as discover_secunet_jobboard
from discover.sources.generic_html import is_same_page_link as is_same_page_link
from discover.sources.generic_html import looks_like_non_job_link as looks_like_non_job_link
...
from discover.sources.ibm import IBM_RESEARCH_GENERIC_MATCH_TERMS as IBM_RESEARCH_GENERIC_MATCH_TERMS
from discover.sources.ibm import IBM_RESULTS_PAGE_SIZE as IBM_RESULTS_PAGE_SIZE
from discover.sources.ibm import IBM_SEARCH_API_URL as IBM_SEARCH_API_URL
from discover.sources.ibm import build_ibm_search_payload as build_ibm_search_payload
from discover.sources.ibm import build_ibm_title_query as build_ibm_title_query
from discover.sources.ibm import discover_ibm_api as discover_ibm_api
from discover.sources.ibm import should_keep_ibm_candidate as should_keep_ibm_candidate
...
from discover.sources.recruitee import discover_recruitee_inline as discover_recruitee_inline
from discover.sources.recruitee import extract_recruitee_app_config as extract_recruitee_app_config
from discover.sources.rheinmetall import build_rheinmetall_page_url as build_rheinmetall_page_url
from discover.sources.rheinmetall import discover_rheinmetall_html as discover_rheinmetall_html
from discover.sources.public_service import AUSWAERTIGES_AMT_ACTION_RE as AUSWAERTIGES_AMT_ACTION_RE
from discover.sources.public_service import BND_BUBBLE_RE as BND_BUBBLE_RE
from discover.sources.public_service import BND_RESULT_RE as BND_RESULT_RE
from discover.sources.public_service import VERFASSUNGSSCHUTZ_RSS_URL as VERFASSUNGSSCHUTZ_RSS_URL
from discover.sources.public_service import build_bnd_search_url as build_bnd_search_url
from discover.sources.public_service import discover_auswaertiges_amt_json as discover_auswaertiges_amt_json
from discover.sources.public_service import discover_bnd_career_search as discover_bnd_career_search
from discover.sources.public_service import discover_bosch_autocomplete as discover_bosch_autocomplete
from discover.sources.public_service import discover_verfassungsschutz_rss as discover_verfassungsschutz_rss
from discover.sources.public_service import extract_verfassungsschutz_section as extract_verfassungsschutz_section
from discover.sources.public_service import extract_verfassungsschutz_value as extract_verfassungsschutz_value
from discover.sources.public_service import fetch_verfassungsschutz_job_details as fetch_verfassungsschutz_job_details
...
from discover.sources.static_pages import apply_pcd_team_detail_text as apply_pcd_team_detail_text
from discover.sources.static_pages import discover_leastauthority_careers as discover_leastauthority_careers
from discover.sources.static_pages import discover_neclab_jobs as discover_neclab_jobs
from discover.sources.static_pages import discover_partisia_site as discover_partisia_site
from discover.sources.static_pages import discover_pcd_team as discover_pcd_team
from discover.sources.static_pages import discover_qedit_inline as discover_qedit_inline
from discover.sources.static_pages import discover_qusecure_careers as discover_qusecure_careers
from discover.sources.static_pages import extract_pcd_team_detail_sections as extract_pcd_team_detail_sections
from discover.sources.thales import THALES_PAYLOAD_TERM_ALIASES as THALES_PAYLOAD_TERM_ALIASES
from discover.sources.thales import THALES_RESULTS_PAGE_SIZE as THALES_RESULTS_PAGE_SIZE
from discover.sources.thales import discover_thales_html as discover_thales_html
