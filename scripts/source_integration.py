    ...
    *,
    ...
    lines.extend(
        [
            ...
            "4. If the board family is shared by multiple accepted sources (Applied, Jobvite, Workable, Recruitee, Personio, Ashby, Lever, Greenhouse, Workday, or similar), prefer a reusable provider module under `scripts/discover/sources/` over a one-off branch.",
            "5. Add dedicated provider parsing/enumeration logic only when config and generic provider support cannot satisfy the canary and quality checks.",
            "Execution modes:",
            ...
            "- Do not modify unrelated sources. Modify this source's track configuration only when the suggested strategy is config tuning or when the URL/mode pivot exception above applies for this same source.",
